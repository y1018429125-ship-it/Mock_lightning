...
_RECORD = {
    ...
    "response": json.loads(r'''{"code": 1001, "data": ["±1100", "±800", "±660", "±500", "1000", "750", "500"]}'''),
}
...
@app.post("/tgyApiservice/reportdataservice/getPressureFilter", summary="getPressureFilter")
async def getPressureFilter(
